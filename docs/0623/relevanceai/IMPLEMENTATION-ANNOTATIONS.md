...
| R#   | 功能                                        | 文件                                                                                                               | 状态   | 说明                                                                                              |
| ---- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------ | ------------------------------------------------------------------------------------------------- |
| R34a | Remote Runner BullMQ distributed queue      | `loops-remote-runner.processor.ts` (新增)                                                                          | 已有码 | BullMQ processor with concurrency 2, rate limiter 20/min, Redis status tracking, 3x retry         |
...
- **Remote Runner**：R34a BullMQ processor 已有码；真实 CLI adapter dispatch 需在各 workerKind case 中集成 runLoop/runShardTests/reviewShard 路径
